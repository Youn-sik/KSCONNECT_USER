...
router.post("/info", (request, response)=> {
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/uid/info`, JSON.stringify(req_data), header_json)
        .then(res=> {
...
// 2. 회원정보 등록/수정
router.post("/info/update", (request, response)=> {
    let ver = request.ver //*프로토콜 버전 (ex: v100)
    let spid = request.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/uid/update`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
...
router.post("/auth", (request, response)=> {
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/auth/uid`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 2. QR인증 요청전송
router.post("/qr_auth", (request, response)=> {
    let ver = request.ver //*프로토콜 버전 (ex: v100)
    let spid = request.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/auth/qr`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 3. QR인증 충전요청
router.post("/qr_auth/charging", (request, response)=> {
    let ver = request.ver //*프로토콜 버전 (ex: v100)
    let spid = request.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/auth/remote/qr`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 4. 회원인증 내역
router.post("/auth/info", (request, response)=> {
    let ver = request.ver //*프로토콜 버전 (ex: v100)
    let spid = request.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/auth/info`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 5.회원인증 결과 등록
router.post("/auth/update", (request, response)=> {
    let ver = request.ver //*프로토콜 버전 (ex: v100)
    let spid = request.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/auth/update`, JSON.stringify(req_data), header_json)
    .then(res=> {
        //응답결과(result) 코드내역
        let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
        let errcode = res.body.errcode //*에러코드
