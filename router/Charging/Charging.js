...
const kepco_host = "xxx.xxx.xxx.xxx"
const kepco_port = 0000
...
// 1. 충전소 정보 조회
router.post("/station/info", (request, response)=> {
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/cs/info`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
...
// 2. 충전기 정보 조회
router.post("/device/info", (request, response)=> {
    let ver = request.body.ver //*프로토콜 버전 (ex: v100)
    let spid = request.body.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/cp/info`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 3. 충전기 상태 조회
router.post("/device/status", (request, response)=> {
    let ver = request.body.ver //*프로토콜 버전 (ex: v100)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/cp/status`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 4. 충전기ID 매핑정보 조회
router.post("/device/id_info", (request, response)=> {
    let ver = request.body.ver //*프로토콜 버전 (ex: v100)
    let spid = request.body.spid //*회원사ID (ex: KPC, HEC)
...
// 5. 충전소 정보 등록/수정
router.post("/station/info/update", (request, response)=> {
    let ver = request.body.ver //*프로토콜 버전 (ex: v100)
    let spid = request.body.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/cs/update`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 6. 충전기 정보 등록/수정
router.post("/device/info/update", (request, response)=> {
    let ver = request.body.ver //*프로토콜 버전 (ex: v100)
    let spid = request.body.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/cp/update`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 7. 충전기 상태정보 등록/수정
router.post("/device/status/update", (request, response)=> {
    let ver = request.body.ver //*프로토콜 버전 (ex: v100)
    let spid = request.body.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/cp/status/update`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 8. 충전기 예약정보 조회
router.post("/device/reserv/info", (request, response)=> {
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/reserv/info`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 9. 충전기 예약정보 등록/수정
router.post("/device/reserv/update", (request, response)=> {
    let ver = request.ver //*프로토콜 버전 (ex: v100)
    let spid = request.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/reserv/update`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
