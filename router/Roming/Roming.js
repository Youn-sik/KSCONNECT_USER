...
// 1. 로밍 충전내역 조회
router.post("/charging/info", (request, response)=> {
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/charge/info`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
...
// 2. 로밍회원 충전진행 상태
router.post("/charging/status", (request, response)=> {
    let ver = request.ver //*프로토콜 버전 (ex: v100)
    let spid = request.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/charge/status`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
router.post("/charging/info/update", (request, response)=> {
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/charge/update`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
router.post("/charging/static/info", (request, response)=> {
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/charge/static`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
router.post("/charging/static/info/history", (request, response)=> {
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/charge/static/detail`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
