...
// 1. 로밍 정산대상 조회
router.post("/user/info", (request, response)=> {
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/calc/info`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
...
router.post("/user/update", (request, response)=> {
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/calc/update`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 3. 로밍 청구내역 조회
router.post("/req/info", (request, response)=> {
    let ver = request.ver //*프로토콜 버전 (ex: v100)
    let spid = request.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/calc/req/info`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 4. 로밍 청구내역 등록/수정
router.post("/req/update", (request, response)=> {
    let ver = request.ver //*프로토콜 버전 (ex: v100)
    let spid = request.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/calc/req/update`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 5. 로밍 결제내역 조회
router.post("/pay/info", (request, response)=> {
    let ver = request.ver //*프로토콜 버전 (ex: v100)
    let spid = request.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/calc/pay/info`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 6. 로밍 결제내역 등록/수정
router.post("/pay/update", (request, response)=> {
    let ver = request.ver //*프로토콜 버전 (ex: v100)
    let spid = request.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/calc/pay/update`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 7. 로밍 계약내역 조회
router.post("/cntr/info", (request, response)=> {
    let ver = request.ver //*프로토콜 버전 (ex: v100)
    let spid = request.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/cntr/info`, JSON.stringify(req_data), header_json)
        .then(res=> {
            //응답결과(result) 코드내역
            let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
            let errcode = res.body.errcode //*에러코드
...
// 8.로밍 계약내역 등록/수정
router.post("/cntr/update", (request, response)=> {
    let ver = request.ver //*프로토콜 버전 (ex: v100)
    let spid = request.spid //*회원사 ID (ex: KPC, HEC)
    ...
    axios.post(`${kepco_host}:${kepco_port}/evapi/v${ver}/${spid}/cntr/update`, JSON.stringify(req_data), header_json)
    .then(res=> {
        //응답결과(result) 코드내역
        let result = res.body.result //*응답결과(result) 내역 (ex: 응답결과(result) 내역 참조)
        let errcode = res.body.errcode //*에러코드
