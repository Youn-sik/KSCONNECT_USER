...
CREATE TABLE `charge_device` (
  ...
  CONSTRAINT `CONSTRAINT_2` CHECK (`status` in ('Y','N'))
...
INSERT INTO `charge_device` VALUES (1,1,'현관 충전기 01번','KSF12345','급속','DC 콤보','24시간','Y',NULL,1,'public'),(2,2,'현관 충전기 01번','KSC23456','완속','AC 완속','08:00~20:00','Y',NULL,1,'apartment'),(3,2,'현관 충전기 02번','KSC34567','완속','AC 완속','08:00~20:00','Y',NULL,2,'company'),(4,1,'현관 충전기 02번','KSC45678','완속','AC 완속','24시간','Y',NULL,2,'public'),(5,1,'주차장 충전기 01번','KSC56789','급속','DC 콤보','24시간','Y',NULL,3,'company'),(6,2,'주차장 충전기 01번','KSC7890','급속','DC 콤보','08:00~20:00','Y',NULL,3,'public'),(7,3,'주차장 충전기 01번','KSS1234','완속','AC 완속','08:00~20:00','Y',NULL,1,'company'),(8,3,'주차장 충전기 02번','KSS1233','급속','DC 콤보','08:00~20:00','Y',NULL,2,'company'),(9,4,'주차장 충전기 01번','KSS1244','완속','AC 완속','08:00~20:00','Y',NULL,1,'company'),(10,4,'주차장 충전기 02번','KSS1452','급속','DC 콤보','08:00~20:00','Y',NULL,2,'company');
...
INSERT INTO `charge_record` VALUES (1,1,1,1,'차량회원번호','N','현대 아이오닉5','00바 0000','기업은행','0000000000000000','신용카드','Y','2022-04-22 14:00:00','2022-04-22 15:00:00','70','70','0','0','20496','20496','0','0','292.8','292.5','292.2','급속','DC 콤보'),(2,1,1,4,'차량회원번호','N','현대 아이오닉5','00바 0000','기업은행','0000000000000000','신용카드','Y','2022-05-08 20:00:00','2022-05-08 21:00:00','50','50','0','0','19829','19829','0','0','292.8','292.5','292.2','완속','AC 완속'),(3,1,2,2,'차량회원번호','N','현대 아이오닉5','00바 0000','기업은행','0000000000000000','신용카드','Y','2022-05-10 09:00:00','2022-05-10 10:00:00','90','90','0','0','23123','23123','0','0','292.8','292.5','292.2','완속','AC 완속'),(4,1,2,3,'차량회원번호','N','현대 아이오닉5','00바 0000','기업은행','0000000000000000','신용카드','Y','2022-05-13 12:00:00','2022-05-13 14:00:00','70','70','0','0','20496','20496','0','0','292.8','292.5','292.2','완속','AC 완속'),(5,1,2,6,'차량회원번호','N','현대 아이오닉5','00바 0000','기업은행','0000000000000000','신용카드','Y','2022-05-15 15:00:00','2022-05-15 16:00:00','90','90','0','0','23123','23123','0','0','292.8','292.5','292.2','급속','DC 콤보'),(6,10,1,1,'차량회원번호','N','현대 아이오닉5','11바 1111','하나은행','0000000000000000','신용카드','Y','2022-04-22 14:00:00','2022-04-22 15:00:00','70','70','0','0','20496','20496','0','0','292.8','292.5','292.2','급속','DC 콤보'),(7,10,1,4,'차량회원번호','N','현대 아이오닉5','11바 1111','하나은행','0000000000000000','신용카드','Y','2022-05-08 20:00:00','2022-05-08 21:00:00','50','50','0','0','19829','19829','0','0','292.8','292.5','292.2','완속','AC 완속'),(8,10,2,2,'차량회원번호','N','현대 아이오닉5','11바 1111','하나은행','0000000000000000','신용카드','Y','2022-05-10 09:00:00','2022-05-10 10:00:00','90','90','0','0','23123','23123','0','0','292.8','292.5','292.2','완속','AC 완속'),(9,10,2,3,'차량회원번호','N','현대 아이오닉5','11바 1111','하나은행','0000000000000000','신용카드','Y','2022-05-13 12:00:00','2022-05-13 14:00:00','70','70','0','0','20496','20496','0','0','292.8','292.5','292.2','완속','AC 완속'),(10,10,2,6,'차량회원번호','N','현대 아이오닉5','11바 1111','하나은행','0000000000000000','신용카드','Y','2022-05-15 15:00:00','2022-05-15 16:00:00','90','90','0','0','23123','23123','0','0','292.8','292.5','292.2','급속','DC 콤보');
...
INSERT INTO `charge_station` VALUES (1,1,'제 1주차장 현관 앞 충전소','Y','2022-04-22 14:41:00','서울특별시 구로구 디지털로27바길 27','24시간',500,'신용카드','37.484631','126.892514'),(2,1,'제 2주차장 현관 앞 충전소','N',NULL,'서울특별시 구로구 디지털로27바길 27','08:00~20:00',300,'신용카드','37.484631','126.892514'),(3,2,'지하 1층 주차장','Y',NULL,'경기 성남시 중원구 제일로35번길 8','08:00~20:00',1000,'신용카드','37.43047','127.135966'),(4,2,'지하 2층 주차장','Y',NULL,'경기 성남시 중원구 제일로35번길 8','08:00~20:00',1000,'신용카드','37.43047','127.135966');
...
INSERT INTO `product_record` VALUES (23,1,1,'Y',30000,1,'2022-04-28 10:17:18',30000),(24,1,3,'Y',70000,3,'2022-04-28 10:17:38',210000),(25,2,2,'Y',50000,2,'2022-04-28 10:18:00',100000),(26,1,2,'Y',50000,2,'2022-05-10 17:42:25',100000),(27,11,4,'Y',100000,3,'2022-05-13 16:12:10',300000),(28,11,3,'Y',70000,2,'2022-05-13 16:46:21',140000),(29,11,3,'Y',70000,1,'2022-05-13 16:47:15',70000),(30,11,2,'Y',50000,1,'2022-05-13 16:48:59',50000),(31,11,3,'Y',70000,1,'2022-05-13 16:49:19',70000),(32,11,2,'Y',50000,1,'2022-05-13 16:49:50',50000),(33,11,2,'Y',50000,1,'2022-05-13 16:50:15',50000),(34,11,1,'Y',30000,1,'2022-05-13 16:52:18',30000);
...
INSERT INTO `user` VALUES (1,'cho','12345','조윤식','yscho11@koolsign.net','010-1111-1111','서울특별시 구로구 디지털로27바길 27','현대 아이오닉 5','00바 0000','기업은행','0000000000000000','0000000000000000',340000),(2,'cho0','12345','정복순','yscho11@koolsign.net','010-1111-1111','서울특별시 구로구 디지털로27바길 27','현대 아이오닉 5','11바 1111',NULL,NULL,NULL,100000),(3,'cho1','12345','김복돌','yscho30@koolsign.net','010-0000-0000','서울특별시 구로구 디지털로27바길 27','현대 아이오닉 5','22바 2222',NULL,NULL,NULL,0),(4,'cho2','12345','김복돌','yscho00@koolsign.net','010-0000-0000','서울특별시 구로구 디지털로27바길 27','현대 아이오닉 5','00바 0000',NULL,NULL,NULL,0),(9,'soo','12345','이수경','soo@koolsign.net','010-1234-5678',NULL,'현대 아이오닉5','19모 3204','기업은행','0000000000000000','0000000000000000',0),(10,'ddd','dddd','ddd','dddd@koolsign.net','010-0000-0000','','현대 아이오닉5','11바 1111','하나은행','0000000000000000','0000000000000000',0),(11,'ccc','cccc','cccc','cccc@cccc','01011112222','','3','123c 1111','','','',760000),(12,'ccc','cccc','cccc','ccc@cccc','01011112222','','2','ccccccccc','','','',0),(13,'ccc','cccc','cccc','ccc@cccc','01011112222','','1','ccccccccc','','','',0);
...
-- Dump completed on 2022-05-23 16:44:11
