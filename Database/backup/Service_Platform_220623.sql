...
INSERT INTO `charge_station` VALUES (1,1,'쿨사인 제 1주차장 현관 앞 충전소','Y','2022-01-01 08:00:00','서울특별시 구로구 디지털로27바길 27','','24시간',500,'신용카드','37.484528','126.892417','company','충전기 안내','2022-01-01 08:00:00','2022-01-01 08:00:00'),(2,1,'쿨사인 제 2주차장 현관 앞 충전소','Y',NULL,'서울특별시 구로구 디지털로27바길 27','','08:00~20:00',300,'신용카드','37.484720','126.892600','company','충전기 안내','2022-01-01 08:00:00','2022-01-01 08:00:00'),(3,2,'조가네 지하 1층 주차장','Y',NULL,'경기도 성남시 중원구 제일로35번길 8','','08:00~20:00',1000,'신용카드','37.430466','127.135928','public','충전기 안내','2022-01-01 08:00:00','2022-01-01 08:00:00'),(4,2,'조가네 지하 2층 주차장','I',NULL,'경기도 성남시 중원구 제일로35번길 8','','08:00~20:00',1000,'신용카드','37.430560','127.135087','public','충전기 안내','2022-01-01 08:00:00','2022-01-01 08:00:00'),(5,1,'구로남초등학교','N',NULL,'서울특별시 구로구 디지털로27길 76 구로남초등학교','','08:00~20:00',500,'신용카드','37.485138','126.890649','public','충전기 안내','2022-01-01 08:00:00','2022-01-01 08:00:00'),(6,1,'국민은행 현관 앞 충전소','F',NULL,'서울특별시 구로구 디지털로 273','','08:00~20:00',1000,'신용카드','37.483852','126.893970','company','충전기 안내','2022-01-01 08:00:00','2022-01-01 08:00:00'),(9,2,'test','N',NULL,'test','','08:00~20:00',0,'신용카드','37.484631','126.892514','public','test','2022-01-01 08:00:00','2022-01-01 08:00:00'),(12,2,'test','N',NULL,'test','','08:00~20:00',0,'신용카드','37.484631','126.892514','public','test','2022-01-01 08:00:00','2022-01-01 08:00:00'),(13,2,'test','N',NULL,'test','','08:00~20:00',0,'신용카드','37.484631','126.892514','public','test','2022-01-01 08:00:00','2022-01-01 08:00:00'),(14,2,'test','N',NULL,'test','','08:00~20:00',300,'신용카드','37.484631','126.892514','public','test','2022-01-01 08:00:00','2022-01-01 08:00:00'),(15,2,'test','N',NULL,'test','','08:00~20:00',300,'신용카드','37.484631','126.892514','public','test','2022-01-01 08:00:00','2022-01-01 08:00:00'),(16,2,'test','N',NULL,'test','','08:00~20:00',300,'신용카드','37.484631','126.892514','public','test','2022-01-01 08:00:00','2022-01-01 08:00:00'),(17,2,'test','N',NULL,'test','','08:00~20:00',300,'신용카드','37.484631','126.892514','public','test','2022-01-01 08:00:00','2022-01-01 08:00:00');
/*!40000 ALTER TABLE `charge_station` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `charge_station_permission`
--

DROP TABLE IF EXISTS `charge_station_permission`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `charge_station_permission` (
  `station_id` int(10) NOT NULL AUTO_INCREMENT,
  `company_id` int(10) NOT NULL,
  `name` varchar(20) NOT NULL,
  `status` varchar(20) NOT NULL,
  ...
  KEY `company_id_FK` (`company_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `charge_station_permission`
--

LOCK TABLES `charge_station_permission` WRITE;
/*!40000 ALTER TABLE `charge_station_permission` DISABLE KEYS */;
INSERT INTO `charge_station_permission` VALUES (1,1,'쿨사인 제 1주차장 현관 앞 충전소','Y','2022-01-01 08:00:00','서울특별시 구로구 디지털로27바길 27','','24시간',500,'신용카드','37.484528','126.892417','company','충전기 안내','','2022-01-01 08:00:00','2022-01-01 08:00:00'),(2,1,'쿨사인 제 2주차장 현관 앞 충전소','Y',NULL,'서울특별시 구로구 디지털로27바길 27','','08:00~20:00',300,'신용카드','37.484720','126.892600','company','충전기 안내','','2022-01-01 08:00:00','2022-01-01 08:00:00'),(3,2,'조가네 지하 1층 주차장','Y',NULL,'경기도 성남시 중원구 제일로35번길 8','','08:00~20:00',1000,'신용카드','37.430466','127.135928','public','충전기 안내','','2022-01-01 08:00:00','2022-01-01 08:00:00'),(4,2,'조가네 지하 2층 주차장','I',NULL,'경기도 성남시 중원구 제일로35번길 8','','08:00~20:00',1000,'신용카드','37.430560','127.135087','public','충전기 안내','','2022-01-01 08:00:00','2022-01-01 08:00:00'),(5,1,'구로남초등학교','N',NULL,'서울특별시 구로구 디지털로27길 76 구로남초등학교','','08:00~20:00',500,'신용카드','37.485138','126.890649','public','충전기 안내','','2022-01-01 08:00:00','2022-01-01 08:00:00'),(6,1,'국민은행 현관 앞 충전소','F',NULL,'서울특별시 구로구 디지털로 273','','08:00~20:00',1000,'신용카드','37.483852','126.893970','company','충전기 안내','','2022-01-01 08:00:00','2022-01-01 08:00:00'),(9,2,'test','N',NULL,'test','','08:00~20:00',0,'신용카드','37.484631','126.892514','public','test','','2022-01-01 08:00:00','2022-01-01 08:00:00'),(12,2,'test','N',NULL,'test','','08:00~20:00',0,'신용카드','37.484631','126.892514','public','test','','2022-01-01 08:00:00','2022-01-01 08:00:00'),(13,2,'test','N',NULL,'test','','08:00~20:00',0,'신용카드','37.484631','126.892514','public','test','','2022-01-01 08:00:00','2022-01-01 08:00:00'),(14,2,'test','N',NULL,'test','','08:00~20:00',300,'신용카드','37.484631','126.892514','public','test','','2022-01-01 08:00:00','2022-01-01 08:00:00'),(15,2,'test','N',NULL,'test','','08:00~20:00',300,'신용카드','37.484631','126.892514','public','test','','2022-01-01 08:00:00','2022-01-01 08:00:00'),(16,2,'test','N',NULL,'test','','08:00~20:00',300,'신용카드','37.484631','126.892514','public','test','','2022-01-01 08:00:00','2022-01-01 08:00:00'),(17,2,'test','N',NULL,'test','','08:00~20:00',300,'신용카드','37.484631','126.892514','public','test','','2022-01-01 08:00:00','2022-01-01 08:00:00');
/*!40000 ALTER TABLE `charge_station_permission` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `company_manager` (
  ...
  `sms_status` int(1) unsigned zerofill DEFAULT NULL,
  `email_status` int(1) unsigned zerofill DEFAULT NULL,
  PRIMARY KEY (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `company_manager` VALUES (1,'yxesboy','yxesboy','ryu','yxesboy@naver.com','010-9561-0258',1111,'서울특별시 구로구 디지털로27바길 27','아이오닉6','1','국민은행','1234-1234-1114-1114','0',0,'0','path','path','path','path','ryu1','ryu1@koolsign.net','010-1111-1111','010-2222-2222','03-03330-0333',0,1),(2,'yxesboy1','yxesboy1','ryu1','yxesboy1@naver.com','010-9561-0258',1111,'서울특별시 구로구 디지털로27바길 27','아이오닉6','1','국민은행','1234-1234-1114-1114','0',0,'0','path','path','path','path','ryu1','ryu1@koolsign.net','010-1111-1111','010-2222-2222','03-03330-0333',0,1),(3,'yxesboy123','yxesboy','ryu','yxesboy@naver.com','010-9561-0258',NULL,'서울특별시 구로구 디지털로27바길 27','아이오닉6','1','국민은행','1234-1234-1114-1114','0',NULL,NULL,'','','','','ryu1','ryu1@koolsign.net','010-1111-1111','010-2222-2222','03-03330-0333',0,1);
...
INSERT INTO `request_charge_station` VALUES (1,1,2,'test','N','test','','08:00~20:00',300,'신용카드','37.484631','126.892514','public','test','2022-06-22 16:15:48','C');
...
-- Dump completed on 2022-06-23 10:46:56
