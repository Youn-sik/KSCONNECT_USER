...
CREATE TABLE `company_manager` (
  ...
  `cal_phone` varchar(50) DEFAULT NULL,
  `cal_fax` varchar(50) DEFAULT NULL,
  `reception_status` int(4) DEFAULT NULL,
  PRIMARY KEY (`uid`)
...
-- Dump completed on 2022-06-21 14:33:02
